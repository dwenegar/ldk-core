...
describe("#stringx", function()
  ...
  describe("findr", function()
    ...
    it("should return the pattern captures", function()
      assert.same({3,6,"2","21"}, {stringx.findr("0123210", "(2)3(21)")})
      assert.same({1,7,"12","4567"}, {stringx.findr("1234567", "(%d+)3(%d+)")})
    end)
  end)
  ...
  describe("rjust", function()
    ...
    it("should pad the string to the left up to the given width", function()
      assert.equal("    xx", stringx.rjust("xx", 6))
      assert.equal("xx", stringx.rjust("xx", 2))
    end)
    it("should return the input string if the width is too small", function()
      assert.equal("xxxxxx", stringx.rjust("xxxxxx", 2))
    end)
    it("should pad the a string using the given padding", function()
      assert.equal("====xx", stringx.rjust("xx", 6, '='))
      assert.equal("-=-xx", stringx.rjust("xx", 5, '-='))
      assert.equal("-=-=xx", stringx.rjust("xx", 6, '-='))
    end)
  end)
  describe("ljust", function()
    ...
    it("should pad the string to the left up to the given width", function()
      assert.equal("xx    ", stringx.ljust("xx", 6))
      assert.equal("xx", stringx.ljust("xx", 2))
    end)
    it("should return the input string if the width is too small", function()
      assert.equal("xxxxxx", stringx.ljust("xxxxxx", 2))
    end)
    it("should pad the a string using the given padding", function()
      assert.equal("xx====", stringx.ljust("xx", 6, '='))
      assert.equal("xx-=-", stringx.ljust("xx", 5, '-='))
      assert.equal("xx-=-=", stringx.ljust("xx", 6, '-='))
    end)
  end)
