...
local native = require 'ldk.array.native'
...
--- Grows a non empty array to the specified length extending it by duplicating its last element.
-- @function grow
...
-- @function shrink
-- @tparam table a an array to be shrunk.
shrink = native.shrink
